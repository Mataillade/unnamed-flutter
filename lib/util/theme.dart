...
class CustomTheme {
  static ThemeData get themeData {
    return ThemeData(
      primaryColor: Color(0xFF002DE3), // Couleur principale de l'application
      hintColor: Color(0xFF879FFF), // Couleur d'accentuation (secondary)
      scaffoldBackgroundColor: Color(0xFFD2D5F9), // Couleur de fond par défaut (background)
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(
          backgroundColor: Color(0xFFFFFFFF), // Couleur du bouton de texte (text_button)
        ),
      ),
      ...
      disabledColor: Color(0xFFADB5BD), // Couleur des éléments désactivés (disabled)
      dividerColor: Color(0xFFEDEDED), // Couleur des séparateurs (divider)
    );
  }
}